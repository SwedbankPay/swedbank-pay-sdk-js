export const PaymentOrderVerifyResponse = {
  payment: {
    ...
    verifications: {
      id: '/psp/paymentorders/payments/7e6cdfc3-1276-44e9-9992-7cf4419750e1/verifications',
    },
    urls: {
      id: '/psp/paymentorders/payments/7e6cdfc3-1276-44e9-9992-7cf4419750e1/urls',
    },
    payeeInfo: {
      id: '/psp/paymentorders/payments/7e6cdfc3-1276-44e9-9992-7cf4419750e1/payeeInfo',
    },
    settings: {
      id: '/psp/paymentorders/payments/7e6cdfc3-1276-44e9-9992-7cf4419750e1/settings',
    },
  },
  operations: [
    {
